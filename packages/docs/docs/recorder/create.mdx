...
Open [`http://localhost:3000`](http://localhost:3000) and in the left sidebar, right-click on the "empty" composition. Select "Duplicate" and give your composition an ID. Confirm.
...
Save, and you should see the new composition when you look at the Remotion Studio on [`http://localhost:3000`](http://localhost:3000).
