...
If you use `@remotion/eslint-config`, the minimum ESLint version is now <MinEslintVersion />. See the [`@remotion/eslint-config`](/docs/eslint-config) documentation for more information.
