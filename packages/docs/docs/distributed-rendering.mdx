...
A reference implementation of a distributed renderer running on Cloudflare is available at [cloudflare-remotion-example](https://github.com/odysseaspapadimas/cloudflare-remotion-example).
It uses Cloudflare Containers, a Durable Object and R2.
