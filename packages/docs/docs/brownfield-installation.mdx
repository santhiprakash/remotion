...
Remotion has an ESLint plugin that warns about improper usage of Remotion APIs. To learn about the available ESLint packages, see [the dedicated ESLint docs](/docs/eslint). To add it to your existing project, install it:
