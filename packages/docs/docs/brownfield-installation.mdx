...
Remotion has an ESLint plugin that warns about improper usage of Remotion APIs. See the [`@remotion/eslint-plugin`](/docs/eslint-plugin) documentation for the full reference.

To add it to your existing project, install it:
