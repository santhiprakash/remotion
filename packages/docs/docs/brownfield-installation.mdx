...
Remotion has dedicated ESLint docs for the shared config, flat-config, and plugin packages. Start there if you want the full setup and compatibility details:

- [ESLint packages](/docs/ai/eslint)
...
To add the plugin to your existing project, install it:
