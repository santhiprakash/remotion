...
- **[@remotion/eslint-config](/docs/eslint)**: `eslint-plugin-react` has been updated to `7.32.2`
- **[@remotion/eslint-config](/docs/eslint)**: `eslint-plugin-react-hooks` has been updated to `4.6.0`
- **[@remotion/eslint-plugin](/docs/eslint)**: New ESLint rule: Use the right import in the config file
