...
- **@remotion/eslint-plugin**: New ESLint rule: Use the right import in the config file. See the [`@remotion/eslint-plugin`](/docs/eslint-plugin) documentation for all rules.
